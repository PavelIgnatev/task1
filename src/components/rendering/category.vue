<template>
    <div class="Diagram-category" :class="'Diagram-category_'+theme">
        <div class="Diagram__wrapper_1">
            <div class="Diagram-category__circle" :class="'Diagram-category__circle_'+index +'_' +theme"></div>
...
export default {
    name: 'category',
    props: ["title", "valueText", "differenceText", "index", "theme"]
}
</script>
<style lang="sass">
.Diagram
        ...
        &__circle
            ...
            &_0
                &_dark
                    ...
                    box-shadow: 0px 0px 20px -8px rgba(248, 158, 0, 0.2), inset -1px 1px 1px rgba(255, 255, 255, 0.5), inset 0px 0px 20px rgba(255, 162, 0, 0.9)
                &_light
