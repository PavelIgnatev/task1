  ...
  <div class="Activity">
    ...
    <div class="Activity__description">
      <div class="Activity-item">
        <div class="item__example" :class="'item__example_' + theme"></div>
        <div class="item__text" :class="'item__text_' + theme">{{ hourInterval }}</div>
      </div>
      <div class="Activity-item">
        <div class="item__example" :class="'item__example_' + theme"></div>
        <div class="item__text" :class="'item__text_' + theme">0</div>
      </div>
      <div class="Activity-item">
        <div class="item__example" :class="'item__example_' + theme"></div>
        <div class="item__text" :class="'item__text_' + theme">1-2</div>
      </div>
      <div class="Activity-item">
        <div class="item__example" :class="'item__example_' + theme"></div>
        <div class="item__text" :class="'item__text_' + theme">3-4</div>
      </div>
      <div class="Activity-item">
        <div class="item__example" :class="'item__example_' + theme"></div>
        <div class="item__text" :class="'item__text_' + theme">5-6</div>
      </div>
    </div>
  </div>
</template>
